...
public class DendroNavigationSystemCompleteAlternateAdvance implements NavigationSystem {
   ...
   public DendroNavigationSystemCompleteAlternateAdvance(DCollection collection,boolean vacio) {
